...
$query = "SELECT * FROM jurang_mangu_barat ORDER BY id DESC LIMIT 100";
$waktu = mysqli_query($conn, $query);
$tinggi_air = mysqli_query($conn, $query);

$query2 = "SELECT * FROM pondok_pucung ORDER BY id DESC LIMIT 100";
$waktu2 = mysqli_query($conn, $query2);

$curah_hujan2 = mysqli_query($conn, $query2);
?>
...
<div class="container">
    ...
    <h1 class="mb-3">Grafik Jurang Mangu Barat</h1>
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
        ...
        <div class="col">
            <div class="card tr-card h-100 border-0 shadow-sm p-3 p-3">
                <div class="card-body">
                    <!-- <h1 class="card-title">Jurang Mangu Barat</h1><hr> -->
    ...
    <script>
        ...
        const dataCurahHujan = {
            ...
            datasets: [{
                ...
                data: [
                    <?php
                    while ($row = mysqli_fetch_array($curah_hujan2)) {
